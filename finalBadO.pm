...
module partyR
	...
	resultR : [0..2];
        ...
        [sendR] turnR=1 & sentBitsR<=(N) & recdBitsR=sentBitsR+1 & !(contactR=1 & resultR=0) & resultR=0 -> (sentBitsR'=sentBitsR+1) & (turnR'=0);


	[reqR] turnR=1 & !(contactR=1) & recdBitsR<=N & (recdBitsR>=1) & (!(resultO=0) | !(recdBitsR=sentBitsR+1)) -> (contactR'=1);
