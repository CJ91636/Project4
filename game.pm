...
player playerO
 partyO, [sendO], [reqO], [begin], [ignoreO], [replyO], [endO]
endplayer
...
module partyO
	...
	//can contact TTP provided it hasn't done so and no. of recieved bits between 1 and N - otherwise unnecessary
        [reqO] turnO=1 & !(contactO=1) & recdBitsO<=N & !(recdBitsO=sentBitsO) & recdBitsO>=1 -> (contactO'=1);
...
module partyR
	...
	[sendR] turnR=1 & sentBitsR=(N) & recdBitsR=sentBitsR+1 & !(contactR=1 & resultR=0) -> (sentBitsR'=sentBitsR+1) & (turnR'=2);
